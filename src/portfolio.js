  ...
  experience: [
    {
      ...
      desc:
        "Back-End Development on an Agile environment for an IoT project.",
      descBullets: [
    ...
    },
    {
      ...
      desc:
        "Database management and mantienance for an immportant client in the banking sector.",
      descBullets: [
        "PL/SQL programming.",
    ...
    },
    {
      ...
      desc:
        "Back-End Development on a BSC spin-off.",
      descBullets: [
...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/images/chickenLogo.webp"),
  ...
  achievementsCards: [
    {
      ...
      image: require("./assets/images/chickenLogo.png"),
      footerLink: [
        {
          name: "Certification",
          url:
